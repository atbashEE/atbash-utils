 ...
 * great work they've done, but also didn't want to force every Shiro(Atbash) user to depend on the commons-codec.jar
 * <p/>
 ...
 */
//@ShiroEquivalent(shiroClassNames = {"org.apache.shiro.codec.Hex"})
@PublicAPI
